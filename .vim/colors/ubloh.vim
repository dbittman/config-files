...
hi StatusLine   guifg=grey guibg=darkgreen gui=bold ctermfg=grey ctermbg=black cterm=bold
...
hi Comment    guifg=grey40 guibg=grey10 gui=italic ctermfg=grey ctermbg=black cterm=italic
